        ...
        public IActionResult ExportExcelListStudent([FromBody] StudentListModel req)
        {
            try
            {
                ...
                using (XLWorkbook wb = new XLWorkbook())
                {
                    ...
                    dataError.Columns.Add("Tên tài khoản", typeof(string));
                    dataError.Columns.Add("Họ và tên", typeof(string));
                    dataError.Columns.Add("Giới tính", typeof(string));
                    dataError.Columns.Add("Khóa", typeof(string));
                    dataError.Columns.Add("Lớp", typeof(string));
                    dataError.Columns.Add("Số điện thoại", typeof(string));
                    dataError.Columns.Add("Email", typeof(string));
                    dataError.Columns.Add("Học kỳ", typeof(string));
                    dataError.Columns.Add("Chuyên ngành", typeof(string));
                    dataError.Columns.Add("Giảng viên hướng dẫn", typeof(string));
